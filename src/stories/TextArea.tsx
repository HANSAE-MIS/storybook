...
export const TextArea = ({ width=320, field='text field', size='medium', error, errorMessage, onChange, setDisabled=false}: TextInputProps) => {
    ...
    return (
        <div className='flex flex-col'>
            ...
            {setDisabled ?
                <textarea className='box-border w-full h-full p-[10px]' name="" id="" onFocus={(event: any) => onFocus(event)} disabled></textarea>
                :
